            ...
            <div className='w-full'>
                ...
                }
                {
                    addMutation.isPending && (
                        <div key={addMutation.variables.id} className='flex justify-between items-center w-100 bg-gray-300 px-4 py-3 rounded my-2 opacity-50'>
                            <div>
...
export default TasksOptimistic;